...
import { Grid, Box, InputLabel, MenuItem, FormControl, Drawer, Badge, Button } from '@mui/material'
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <Button className={styles.buttonCart} onClick={() => setCartOpen(true)}>
          <Badge>
            <AddShoppingCart />
          </Badge>
        </Button>
        <Box sx={{ minWidth: 200 }}>
          <FormControl className={styles.category} fullWidth>
